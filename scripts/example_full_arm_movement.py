...
class ExampleFullArmMovement:
    def __init__(self):
        try:
            ...
            self.degrees_of_freedom = rospy.get_param("/" + self.robot_name + "/degrees_of_freedom", 0)
    ...
    def example_send_cartesian_pose(self):
        ...
        req.input.target_pose.theta_x = feedback.base.commanded_tool_pose_theta_x + 180
